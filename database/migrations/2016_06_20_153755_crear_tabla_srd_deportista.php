...
class CrearTablaSrdDeportista extends Migration
{
    ...
    public function up()
    {
        Schema::create('TB_SRD_DEPORTISTA', function (Blueprint $table) {
            ...
            $table->integer('FK_I_ID_ETAPA_NACIONAL')->unsigned()->nullable();
            $table->integer('FK_I_ID_ETAPA_INTERNACIONAL')->unsigned()->nullable();
            ...
            $table->foreign('FK_I_ID_ETAPA_NACIONAL')->references('PK_I_ID_ETAPA')->on('TB_SRD_ETAPA');
